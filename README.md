...
### Configuración IPV6
### Utilización de Infraestructura IPV4
#### Router 1
```sh
ena
conf t
...
ip´v6 rip redv6 enable
no shutdown
exit
int gig0/1
ip adress 192.168.1.1 255.255.255.252
no shutdown
exit
interface Tunel0
...
conf t
int gig0/0
ip adress 192.168.1.2 255.255.255.252
no shutdown
exit
int gig0/1
ip adress 192.168.1.5 255.255.255.252
no shutdown
exit
router ospf 1
router-id 2.2.2.2
...
ipv6 unicast-routing
int gig0/0
ip adress 192.168.1.6 255.255.255.252
no shutdown
exit
router ospf 1
router-id 3.3.3.3
...
exit
int Tunnel10
ipv6 adress 3000::2/112
ipv6 rip redv6 enable
tunnel source gig0/0
tunnel detination 192.168.1.1
tunnel mode ipv6ip
exit
```
